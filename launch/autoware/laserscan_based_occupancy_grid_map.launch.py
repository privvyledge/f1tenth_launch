...
def launch_setup(context, *args, **kwargs):
    ...
    composable_nodes = [
        ComposableNode(
            ...
            condition=IfCondition(LaunchConfiguration("publish_scan_from_pointcloud")),
            remappings=[
                (
                    "~/input/pointcloud",
                ...
                (
                    "~/output/laserscan",
                    LaunchConfiguration("input/laserscan"),
                ),
                (
                    "~/output/pointcloud",
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            add_launch_arg("publish_scan_from_pointcloud", "true"),
